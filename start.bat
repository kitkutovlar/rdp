...
echo IP:
tasklist | find /i "ngrok.exe" >Nul && powershell -Command "(Invoke-RestMethod http://127.0.0.1:4040/api/tunnels).tunnels[0].public_url" || echo "Failed to retrieve NGROK authtoken - check again your authtoken"
